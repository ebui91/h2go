      ...
      <div className='about-main-container'>
        ...
        <div className='testimonials-container'>
          ...
          <div className='steven-testimonial'>
              <img className='testimonial-avatar' src={ require('../../images/steven-test.png') } alt='testimonial' />
              <h3> Steven Isbell </h3>
              <hr />
              <p><span className='test-quote'>''</span>Really, really cool piece of tech. <div className='steven-img'><span role='img'>👌🏻</span></div><span className='test-quote'>''</span></p>
          </div>

          <div className='testimonial-cols'>
            <div className='testimonial-ind'>
              <img className='testimonial-avatar' src={ require('../../images/kara-test.png') } alt='testimonial'/>
            ...
            <div className='testimonial-ind'>
              <img className='testimonial-avatar' src={ require('../../images/matt-test.png') } alt='testimonial' />
              <h3> Matthew H. Carson </h3>
              <hr className='test-line-break'/>
              <p className='testimonial'><span className='test-quote'>''</span> 10/10. Our family has been loyal customers to H2GO for over 20 years. I would never go anywhere else to buy water! <span className='test-quote'>''</span></p>
            </div>

            <div className='testimonial-ind'>
              <img className='testimonial-avatar' src={ require('../../images/zach-test.png') } alt='testimonial' />
            ...
            <div className='testimonial-ind'>
              <img className='testimonial-avatar' src={ require('../../images/aja-test.png') } alt='testimonial' />
              <h3> Aja Cederberg </h3>
              <hr className='test-line-break'/>
